    ...
    Flickable {
      ...
      Column {
                  ...
                  Row {
                    ...
                    Repeater {
                      ...
                      Rectangle {
                        ...
                        height: Style.space(24)
                        radius: Style.space(4)
                        color: root.barSection === modelData
                          ? Qt.rgba(Color.accent.r, Color.accent.g, Color.accent.b, 0.2)
                          : Qt.rgba(root.contentForeground.r, root.contentForeground.g, root.contentForeground.b, 0.05)
                        border.color: root.barSection === modelData ? Color.accent : "transparent"
                        border.width: 1
                        ...
                        Text {
                          ...
                          font.family: root.contentFontFamily
                          font.pixelSize: Style.font.caption
                          font.bold: root.barSection === modelData
                          color: root.barSection === modelData ? Color.accent : root.contentForeground
                        }
        ...
        Column {
          ...
          Rectangle {
            width: parent.width
            height: artworkCardCol.implicitHeight
            radius: Style.space(6)
            color: Qt.rgba(root.contentForeground.r, root.contentForeground.g, root.contentForeground.b, 0.03)
            border.color: Qt.rgba(root.contentForeground.r, root.contentForeground.g, root.contentForeground.b, 0.08)
            border.width: 1
            ...
            Column {
                ...
                Row {
                  ...
                  Rectangle {
                    ...
                    Rectangle {
                      ...
                      radius: width / 2
                      anchors.verticalCenter: parent.verticalCenter
                      x: root.artworkEnabled ? parent.width - width - Style.space(2) : Style.space(2)
                      color: Color.background
                      Behavior on x { NumberAnimation { duration: 100 } }
                    }
                    ...
                    MouseArea {
                      ...
                      cursorShape: Qt.PointingHandCursor
                      onClicked: {
                        root.artworkEnabled = !root.artworkEnabled
                        root.applySettings()
                      }
                    }
                  }
              ...
              // Fetch missing thumbnails from article pages
              Item {
                width: parent.width
                height: Style.space(46)
                opacity: root.artworkEnabled ? 1.0 : 0.4
                ...
                Row {
                  ...
                  Text {
                    anchors.verticalCenter: parent.verticalCenter
                    width: parent.width - Style.space(60)
                    text: "Fetch missing thumbnails from article pages"
                  ...
                  Rectangle {
                    ...
                    height: Style.space(20)
                    radius: Style.space(10)
                    color: root.artworkAllowPageFetch
                      ? Color.accent
                      : Qt.rgba(root.contentForeground.r, root.contentForeground.g, root.contentForeground.b, 0.15)
                    ...
                    Rectangle {
                      ...
                      radius: width / 2
                      anchors.verticalCenter: parent.verticalCenter
                      x: root.artworkAllowPageFetch ? parent.width - width - Style.space(2) : Style.space(2)
                      color: Color.background
                      Behavior on x { NumberAnimation { duration: 100 } }
                    }
